...
#' @param x11.sigmaVector vector to specifies one of the two groups of periods for whose standard errors used for extreme values detection and adjustment will be computed. Only used if \code{x11.calendarSigma = "Select"}. Possib
