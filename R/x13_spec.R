...
#' @param x11.lsigma numeric: the lower sigma boundary for the detection of extreme values.
#' @param x11.usigma numeric: the upper sigma boundary for the detection of extreme values.
...
#' 1 - same seasonal filters for all periods (e.g.: \code{seasonalma=c("Msr")});
#' or the period length - a seasonal filer is defined for each period (e.g. for quarterly series: \code{seasonalma=c("S3X3","Msr","S3X3","Msr")}).
#' Possible filters are: \code{"Msr", "Stable", "X11Default", "S3X1", "S3X3", "S3X5", "S3X9", "S3X15"}.
#' \code{"Msr"} - the program chooses the final seasonal filter automatically.
#' @param x11.fcasts numeric: the number of forecasts generated by the RegARIMA model in periods (positive values) or years (negative values).
#' @param x11.bcasts numeric: the number of backcasts used in X11. Negative figures are translated in years of backcasts.
...
#' @param x11.excludeFcasts logical: to exclude forecats and backcasts. If \code{TRUE}, the RegARIMA model forecasts and backcasts are not used during the detection of extreme values in the seasonal adjustment routines.
#'
#' @details
#'
...
#' }
#' @return
#' A two-elements list of class \code{c("SA_spec", "X13")}, containing:
